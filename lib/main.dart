...
import 'package:flutter_demo/demo4/screens/home/index.dart';
import 'package:flutter_demo/demo5/screens/welcome/index.dart';
      ...
      child: Consumer<ThemeProvider>(builder: (context, appInfo, _) {
        ...
        return MaterialApp(
          ...
          routes: {
            ...
            "/demo5": (BuildContext context) => new EBook(),
          },
        );
      }),
    );
